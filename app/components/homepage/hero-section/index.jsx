...
function HeroSection() {
  const { t } = useLanguage();
  const typewriterWords = t("typewriter.words") || ["Product Builder"];
  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      <Image
        ...
        width={1572}
        height={795}
        className="absolute -top-[98px] -z-10 w-full h-auto max-w-full"
      />
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        ...
        >
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            ...
            {t("hero.iAmA")}{' '}
            <Typewriter words={Array.isArray(typewriterWords) ? typewriterWords : [typewriterWords]} speed={80} deleteSpeed={40} pause={2000} />
          </h1>
          ...
          <div className="overflow-x-auto border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">{t("hero.codeName")}</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">productBuilder:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
              ...
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="mr-2 text-white">productBuilder</span>
                <span className="text-amber-300">&amp;&amp;</span>
              </div>
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
