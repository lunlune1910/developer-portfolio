...
const SingleProject = ({ project }) => {
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 flex justify-center opacity-40 w-full">
        <svg className="w-full h-auto" viewBox="0 0 1170 403" fill="none" xmlns="http://www.w3.org/2000/svg">
